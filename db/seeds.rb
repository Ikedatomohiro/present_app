...
user = User.create(name: "いけだとも", gender_id: 1, birthday: "2019-05-01", email: "to.tomo.tomohiro@gmail.com", password: "Tomohir0", admin: "true")
user = User.create(name: "ともひろ", gender_id: 1, birthday: "1999-12-31", email: "tomohiro.ikeda@gmail.com", password: "tomohiro", admin: "false")
